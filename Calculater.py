...
btn_multi = tk.Button(root, text='x', command=lambda: add_to_calculation('x'), width=5, font=('Arial', 14)) 
...
btn_equals = tk.Button(root, text='=', command=lambda: evaluate_calculation, width=8, font=('Arial', 14)) 
